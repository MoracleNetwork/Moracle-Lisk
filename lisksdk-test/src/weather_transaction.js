...
const processWeatherTransaction = require("./processWeatherTransaction");

class WeatherTransaction extends BaseTransaction {
    /**
    ...
    applyAsset(store) {
        const errors = [];
        processWeatherTransaction(this);
...
module.exports = WeatherTransaction;
