...
const processDollarAmountTransaction = require("./processDollarAmountTransaction");

class DollarAmountTransaction extends BaseTransaction {
    /**
    ...
    applyAsset(store) {
        const errors = [];
        processDollarAmountTransaction(this);
...
module.exports = DollarAmountTransaction;
